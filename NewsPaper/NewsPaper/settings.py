...
SECRET_KEY = 'django-insecure-#mulcl3%192rx9m^3f1n6h#+n25+^hshq$8oc#tftro2hgg6*z'
...
class NoStackAdminEmailHandler(AdminEmailHandler):
...
LOGGING = {
    ...
    'handlers': {
        ...
        'mail_admins': {
            'level': 'ERROR',
            'filters': ['require_debug_false'],
            'class': NoStackAdminEmailHandler,
            'formatter': 'error_format',
            'include_html': False,
        },
    },
